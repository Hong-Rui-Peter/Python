...
class Pad(pg.sprite.Sprite):
    def __init__(self):
        pg.sprite.Sprite.__init__(self)
        self.image = pg.image.load("pad.jpg")  #滑板圖片
        self.image.convert()
        self.image=pg.transform.scale(self.image, (200,15))
        self.rect = self.image.get_rect()
...
soundhit = pg.mixer.Sound("kick.mp3")  #碰到磚塊音效
soundpad = pg.mixer.Sound("punch.mp3")  #碰到滑板音效
#背景
