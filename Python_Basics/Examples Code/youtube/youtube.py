...
yt.streams.filter().get_highest_resolution().download(
    filename="Never_Gonna_Give_You_Up_HD.mp4",
    output_path="C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/youtube/downloads",
)
print("下載完成")
...
yt.streams.filter().get_by_resolution("360p").download(
    filename="Never_Gonna_Give_You_Up_360p.mp4",
    output_path="C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/youtube/downloads",
)
print("下載完成")
