...
if not os.path.exists(
    "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/ffmpeg"
):  # ./ffmpeg.zip
    print("[下載 ffmpeg]")
    wget.download(
        "https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-essentials.zip",
        "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/ffmpeg.zip",  # ./ffmpeg.zip
    )
    ...
    with zipfile.ZipFile(
        ...
        print("[解壓縮 zip]")
        zf.extractall(
            path="C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter"
        )  # ./

        # 更改資料夾名稱
        os.rename(
            zf.namelist()[0],
            "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/ffmpeg",  # ./ffmpeg
        )

# 下載 yt-dlp
if not os.path.exists(
    "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/ffmpeg/bin/yt-dlp.exe"  # ./ffmpeg/bin/yt-dlp.exe
):
    print("[下載 yt-dlp]")
    wget.download(
...
# 判斷影片是否已經下載
if not os.path.exists(
    f"C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/video_1/{video_id}.mp4"  # ./{video_id}.mp4
):
    # 設定下載影片指令
    cmd = [
        "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/ffmpeg/bin/yt-dlp.exe",  # ./ffmpeg/bin/yt-dlp.exe
        ...
        "w[ext=mp4]",
        "-o",
        "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/video_1/%(id)s.%(ext)s",  # ./%(id)s.%(ext)s
    ]
...
if choice == 1:  # 切割影片 方式1 (設定持續時間，意思是從 ss 開始往後多少時間，速度快)
    cmd = [
        "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/ffmpeg/bin/ffmpeg.exe",  # ./ffmpeg/bin/ffmpeg.exe
        "-ss",
        "00:02:43.000",
        "-i",
        f"C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/video_1/{video_id}.mp4",  # ./{video_id}.mp4
        ...
        "-c",
        "copy",
        "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/video_cutter/video_1/after.mp4",  # ./output.mp4
    ]
