...
import os, time, wget, zipfile

# 確認 資料夾是否存在
if not os.path.exists(
    "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/語音一"
):
    # 建立資料夾
    os.makedirs(
        "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/語音一"
...
# 確認 資料夾是否存在
if not os.path.exists(
    "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/語音二"
):
    # 建立資料夾
    os.makedirs(
        "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/語音二"
...
cmd = [
    ...
    "-o",
    f"C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/語音一/{words}.mp3",
]
...
# 下載 ffmpeg
if not os.path.exists(
    "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/ffmpeg"
):  # ./ffmpeg.zip
    print("[下載 ffmpeg]")
    wget.download(
        "https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-essentials.zip",
        "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/ffmpeg.zip",  # ./ffmpeg.zip
    )
    ...
    with zipfile.ZipFile(
        ...
        print("[解壓縮 zip]")
        zf.extractall(
            path="C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound"
        )  # ./

        # 更改資料夾名稱
        os.rename(
            zf.namelist()[0],
            "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/ffmpeg",  # ./ffmpeg
        )
...
"""
cmd = [
    "C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics\Examples Code/google_lady_sound/ffmpeg/bin/ffmpeg.exe",  # 左邊是 Windows 指令。MacOS: ./ffmpeg
    "-i",
    f"C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/語音一/{words}.mp3",
    "-filter:a",
    "atempo=1.5",
    f"C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/語音一/{words}_atempo.mp3",
]
std_output = subprocess.run(cmd)
if std_output.returncode == 0:
    print(f"[{words}] 轉換成功")
...
list_words = ["人生短短幾個秋啊", "不醉不罷休", "東邊我的美人哪", "西邊黃河流"]
...
for index, words in enumerate(list_words):
    ...
    cmd = [
        ...
        "-o",
        f"C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/語音二/{index}.mp3",
    ]
    ...
    cmd = [
        ...
        # f"./mp3/{index}_altered.mp3",
        f"C:/Users/hongr/OneDrive/桌面/Programming Language/Python/Python_Basics/Examples Code/google_lady_sound/語音二/{index}_altered.mp3",
    ]
    std_output = subprocess.run(cmd)
    if std_output.returncode == 0:
