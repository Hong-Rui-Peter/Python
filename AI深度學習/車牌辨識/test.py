...
pytesseract.pytesseract.tesseract_cmd = r"C:/Users/hongr/OneDrive/桌面/Programming Language/Python/AI深度學習/車牌辨識/tesseract/tesseract.exe"

# 讀取圖像
image = cv2.imread("./AI深度學習/車牌辨識/1051k7.jpg")
...
edges = cv2.Canny(gray_image, 0.5, 1)
